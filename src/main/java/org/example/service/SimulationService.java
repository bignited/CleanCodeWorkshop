...
public class SimulationService {
    ...
    public void runBookStoreAddBooksSimulation() {
    ...
    public void runFilterBooksByTitleSimulation() {
    ...
    public void runTopRatedBooksSimulation() {
    ...
    public void runUpdateBookSimulation() {
    ...
    public void runRemoveBookSimulation() {
    ...
    public void runGetTotalBookPriceFromBookStoreSimulation() {
    ...
    public void runGetAverageBookPriceFromBookStoreSimulation() {
    ...
    public void runSellBookSimulation() {
    ...
    public void runTotalRevenueSimulation() {
    ...
    public void runTotalBooksSoldSimulation() {
    ...
    public void runBooksByRatingRangeSimulation() {
    ...
    public void runBooksSortedByPriceSimulation() {
